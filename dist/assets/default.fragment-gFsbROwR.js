import{t as e}from"./shaderStore-jR05XatJ.js";import"./fogFragment-DQ_raz13.js";import"./logDepthDeclaration-4o29r2oI.js";import"./helperFunctions-D8Wfw8PY.js";var t=`decalFragmentDeclaration`,n=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`lightFragmentDeclaration`,u=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`lightUboDeclaration`,f=`#ifdef LIGHT{X}
uniform Light{X}
...
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`lightsFragmentFunctions`,v=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`shadowsFragmentFunctions`,b=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`samplerFragmentDeclaration`,S=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`fresnelFunction`,w=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`reflectionFunction`,E=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`imageProcessingDeclaration`,O=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`imageProcessingFunctions`,A=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`bumpFragmentMainFunctions`,M=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`bumpFragmentFunctions`,P=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`bumpFragment`,I=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`decalFragment`,R=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`depthPrePass`,B=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`lightFragment`,H=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U=`logDepthFragment`,W=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);var G=`oitFragment`,K=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=K);var q=`defaultPixelShader`,J=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[q]||(e.ShadersStore[q]=J);var Y={name:q,shader:J};export{Y as defaultPixelShader};